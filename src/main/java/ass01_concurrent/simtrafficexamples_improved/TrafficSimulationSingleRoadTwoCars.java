...
public class TrafficSimulationSingleRoadTwoCars extends AbstractSimulation {
	...
	public TrafficSimulationSingleRoadTwoCars(Random random) {
	...
	public void setup() {
		...
		CarAgent car1 = new CarAgentBasic("car-1", env, r, 0, 0.1, 0.2, 8, newRandomGenerator());
		this.addAgent(car1);		
		CarAgent car2 = new CarAgentBasic("car-2", env, r, 100, 0.1, 0.1, 7, newRandomGenerator());
		this.addAgent(car2);
